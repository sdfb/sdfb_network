...
load("/data/ODNB_fullnamelist.Rdata")
load("/data/ODNB_entitymatrix.Rdata")
load("/data/ODNB_improvedpred.Rdata")
...
save(base_doccount, file = "/data/ODNB_basecounts.Rdata")
#load("../../private_data/odnb_data_proc/ODNB_basecounts.Rdata")
load("/data/ODNB_basecounts.Rdata")
...
save(row_Docs, col_Ids, base_doccount, need_torandomize, file = "/data/ODNB_allcounts.Rdata")
...
save(f_count_mat, f_col_Ids, f_row_Docs, f_randlist, file = "/data/ODNB_fincounts.Rdata")

#save(f_count_mat, f_randlist, file = "041514_sparsedm.Rdata")
save(f_count_mat, f_randlist, file = "/data/041514_sparsedm.Rdata")
...
for(k in 1:100) {
  ...
  save(SUBSET_DM, file = paste("/data/", "subsetdm", k, ".Rdata", sep = ""))
}
## To do: Fit model

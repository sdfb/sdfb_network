...
if (PARAM_START < 2) {
  ...
  load("private_data/odnb_data_proc/ODNB_ner_tokenized1.Rdata")
...
if (PARAM_START < 3) {
  ...
  load("private_data/odnb_data_proc/ODNB_ner_tokenized2.Rdata")
...
if (PARAM_START < 4) {
  ...
  rm(ODNB_tokenized2)
  load("private_data/odnb_data_proc/ODNB_ner_tokenized3.Rdata")
